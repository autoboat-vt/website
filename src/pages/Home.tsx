            ...
            <section className="section">
                ...
                <Card>
                    ...
                    <div className="subteam-grid">
                        {SUBTEAMS.map((s) => (
                            <Link key={s.id} to={`/ourteam#${s.id}`} className="subteam-badge">
                ...
                <Card>
                    ...
                    <p style={{ marginBottom: "1.5rem" }}>
                        If you would like to get updates on what we are up to, join our Discord server.
                    </p>
                ...
                <Card>
                    ...
                    <div className="cta-actions">
                        ...
                        <a href="mailto:autoboat@vt.edu" className="btn btn--secondary">
                            Email Sponsorship
                        </a>
                    </div>
                </Card>
